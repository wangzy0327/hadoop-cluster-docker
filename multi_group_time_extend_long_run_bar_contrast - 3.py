...
num_list1 = [65.423,71.615,74.240,67.844,80.550,83.885,94.196,102.114,107.247,119.015,122.331,143.431,144.381,146.963,165.055]
num_list2 = [43.829,45.536,51.187,50.914,57.802,57.826,64.287,66.214,71.253,81.424,80.943,81.426,84.020,90.584,90.385]
...
"""
rects1 = plt.bar(x=x, height=num_list1, width=0.8, alpha=0.8, color='red', label="4节点从0扩容")
rects2 = plt.bar(x=[i + 0.8 for i in x], height=num_list2, width=0.8, color='green', label="4节点无需扩容")
