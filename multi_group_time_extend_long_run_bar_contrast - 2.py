...
num_list1 = [58.649,65.177,71.838,73.961,81.998,83.191,102.915,102.386,106.017,122.526,126.466,140.656,150.064,154.065,162.720]
...
"""
rects1 = plt.bar(x=x, height=num_list1, width=0.8, alpha=0.8, color='red', label="2节点从0扩容")
