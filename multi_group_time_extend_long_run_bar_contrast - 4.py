...
num_list1 = [70.757,76.630,78.212,74.223,74.272,73.701,75.170,92.714,101.522,114.410,113.793,124.259,124.203,139.540,142.932]
num_list2 = [58.649,65.177,71.838,73.961,81.998,83.191,102.915,102.386,106.017,122.526,126.466,140.656,150.064,154.065,162.720]
num_list3 = [65.423,71.615,74.240,67.844,80.550,83.885,94.196,102.114,107.247,119.015,122.331,143.431,144.381,146.963,165.055]
...
rects2 = plt.bar(x=[i + 0.8 for i in x], height=num_list2, width=0.8, color='green', label="2节点从0扩容")
rects3 = plt.bar(x=[i + 0.8*2 for i in x], height=num_list3, width=0.8, color='lightskyblue', label="4节点从0扩容")
